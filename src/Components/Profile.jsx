  ...
  return (
    <div className="max-w-6xl mx-auto pb-10 px-4 grid grid-cols-1 md:grid-cols-6 gap-6">
      ...
      <div className="md:col-span-2 flex items-start py-10">
        ...
        <div className="flex flex-col space-y-2 ml-6 pt-10">
