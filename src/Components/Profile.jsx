...
const ProfileSlider = () => {
  return (
    ...
    <div className="col-span-2 grid-cols-sm-8 mx-auto ml-0 pl-4 pb-6 pr-2 pt-6">
        <p className="first-paragraph pt-4 pb-4 text-xl"><span className="name text-gray-600">Lucky Malefu</span>  is a marketing professional who started his career in 2017 
        ...
        <p className="first-paragraph pb-4 text-xl">
