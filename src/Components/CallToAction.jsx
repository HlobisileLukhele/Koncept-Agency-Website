  ...
  backgroundSize: "cover",
    ...
    className="container-fluid text-center cta-container pt-7 pb-10 items-cente sm:mx-auto md:mx-auto w-auto">
      <div className=" items-center pr-10 md:mx-auto w-auto">
        <h2 className="text-hook pb-3 pt-4 md:p-0 m-0 text-2xl">Let us bring your ideas to life!</h2>
        <p className="text-paragraph pb-4 pt-3">Let’s have a chat about how we can creatively breathe life into your ideas and brands.</p>
