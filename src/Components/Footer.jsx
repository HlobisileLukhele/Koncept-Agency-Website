    ...
    <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                ...
                <img src={KonceptAgency} alt="Koncept illustration logo" />

                </a>
                <p className="text-sm text-gray-500 mb-6 mt-4 "> Koncept Agency is a branding and advertising agency that focuses on corporate branding, digital illustration and etc. </p>
                <div className="mt-4">
                    <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                    <p className="text-gray-500 cursor-pointer hover:text-gray-700 mb-2 text-md">Connect on :</p>
            ...
            <div className="flex flex-wrap flex-grow mt-6 mb-4text-center md:pl-20 md:mt-0 md:text-left">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">hello@keonceptagency.co.za</a>
                        </li>
                        <li className="mt-3">
        ...
        <div className="bg-gray-300">
            <div className="container  px-5 py-4 mx-auto mb-0 mt-0">
