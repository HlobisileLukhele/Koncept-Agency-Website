...
const AboutUs = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 md:mx-auto pb-6">
    <div className="col-span-1 border-gray-50">
    <img src={CompanyLogos} className="image-fluidlogo-structures  flex items-right  md:w-fit h-200" />
    </div>
    <div className="col-span-1 ">
      <div className="items-right pr-10 pt-20 md:tems-center pr-4 pl-4">
      <p className="company-par pb-5 pt-20 text-gray-600 md: pb-2 pt-2 text-gray-600">
